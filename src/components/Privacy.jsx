            ...
            <span>
              <span data-custom-class='body_text'>
                ...
                <bdt className='question'>
                  Uppist Limited
                  <bdt className='block-component' />
                  (doing business as <bdt className='question'>Luround</bdt>)
                  <bdt className='statement-end-if-in-editor' />
                </bdt>
        ...
        <ul>
          <li data-custom-class='body_text' style={{ lineHeight: "1.5" }}>
            <span style={{ fontSize: 15 }}>
              ...
              <bdt className='question'>
                Luround is an all-in-one app that helps coaches, consultants and
                creatives manage different aspects of their businesses such as
                scheduling, invoicing and CRM in one place.
              </bdt>
            </span>
            <bdt className='statement-end-if-in-editor'>
              <span style={{ fontSize: 15 }} />
          ...
          <span style={{ fontSize: 15 }}>
            <span style={{ color: "rgb(127, 127, 127)" }}>
              <span data-custom-class='body_text'>
                ...
                at <bdt className='question'>support@luround.com</bdt>.
              </span>
            </span>
          </span>
        </div>
                            ...
                            >
                              <span style={{ fontSize: 15 }}>
                                <span data-custom-class='body_text'>
                                  ...
                                  our legal obligations, respond to legal
