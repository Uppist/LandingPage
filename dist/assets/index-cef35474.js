...
function Ns(e, t, n) {
  ...
  if (t != null)
    ...
    t))
      Ls.call(t, r) && !Ts.hasOwnProperty(r) && (i[r] = t[r]);
...
U.StrictMode = Sd;
U.Suspense = Ed;
U.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = zd;
U.act = Ms;
...
U.isValidElement = Yo;
U.lazy = function (e) {
  return { $$typeof: xd, _payload: { _status: -1, _result: e }, _init: Md };
};
U.memo = function (e, t) {
...
function zs(e, t, n) {
  ...
  for (r in t) Hd.call(t, r) && !Fd.hasOwnProperty(r) && (i[r] = t[r]);
  if (e && e.defaultProps)
...
function Jd(e, t, n, r, i, l, o, u, a) {
  (Zn = !1), (li = null), qd.apply(Gd, arguments);
}
function e1(e, t, n, r, i, l, o, u, a) {
  if ((Jd.apply(this, arguments), Zn)) {
    if (Zn) {
      var c = li;
      (Zn = !1), (li = null);
...
function tc(e) {
  return (e = t1(e)), e !== null ? nc(e) : null;
}
function nc(e) {
...
var rc = ze.unstable_scheduleCallback,
  ...
  n1 = ze.unstable_shouldYield,
  r1 = ze.unstable_requestPaint,
  re = ze.unstable_now,
  i1 = ze.unstable_getCurrentPriorityLevel,
  iu = ze.unstable_ImmediatePriority,
  ic = ze.unstable_UserBlockingPriority,
  ui = ze.unstable_NormalPriority,
  l1 = ze.unstable_LowPriority,
  lc = ze.unstable_IdlePriority,
  Ai = null,
  Je = null;
function o1(e) {
...
var Qe = Math.clz32 ? Math.clz32 : s1,
  u1 = Math.log,
  a1 = Math.LN2;
function s1(e) {
  return (e >>>= 0), e === 0 ? 32 : (31 - ((u1(e) / a1) | 0)) | 0;
}
var Mr = 64,
  zr = 4194304;
function bn(e) {
...
function Hn(e, t) {
  e.blockedOn === t &&
    ...
    oo ||
      ((oo = !0),
      ze.unstable_scheduleCallback(ze.unstable_NormalPriority, v1)));
}
function or(e) {
  function t(i) {
    return Hn(i, e);
  ...
  for (; 0 < gt.length && ((n = gt[0]), n.blockedOn === null); )
    dc(n), n.blockedOn === null && gt.shift();
}
...
function uu(e, t, n, r) {
  if (si) {
    ...
    else if ((na(e, r), t & 4 && -1 < p1.indexOf(e))) {
      for (; i !== null; ) {
        var l = kr(i);
        if (
          (l !== null && ac(l),
...
var zn = {
  ...
  la = je(Wi),
  w1 = ee({}, Wi, { dataTransfer: 0 }),
  S1 = je(w1),
  C1 = ee({}, Cr, { relatedTarget: 0 }),
  hl = je(C1),
  k1 = ee({}, zn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  _1 = je(k1),
  O1 = ee({}, zn, {
...
var M1 = ee({}, Cr, {
  ...
  D1 = je(j1),
  I1 = ee({}, zn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  H1 = je(I1),
  $1 = ee({}, Wi, {
    deltaX: function (e) {
...
var W1 = st && "TextEvent" in window && !Kn,
  vc = st && (!fu || (Kn && 8 < Kn && 11 >= Kn)),
...
function V1(e, t) {
  if (en)
    return e === "compositionend" || (!fu && mc(e, t))
      ? ((e = hc()), (Kr = au = St = null), (en = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
if (st) {
  ...
  wc = vl && (!document.documentMode || 9 < document.documentMode);
}
function da() {
  Yn && (Yn.detachEvent("onpropertychange", Sc), (ur = Yn = null));
}
function Sc(e) {
  if (e.propertyName === "value" && Ui(ur)) {
    var t = [];
    gc(t, ur, e, ru(e)), Js(B1, t);
  }
}
function Z1(e, t, n) {
  e === "focusin"
    ? (da(), (Yn = t), (ur = n), Yn.attachEvent("onpropertychange", Sc))
    : e === "focusout" && da();
}
function K1(e) {
...
var Ke = typeof Object.is == "function" ? Object.is : q1;
function ar(e, t) {
  if (Ke(e, t)) return !0;
...
var J1 = st && "documentMode" in document && 11 >= document.documentMode,
  tn = null,
  ao = null,
  Xn = null,
  so = !1;
...
function Vi(e) {
  ...
  var t = nn[e],
    n;
  for (n in t) if (t.hasOwnProperty(n) && n in _c) return (yl[e] = t[n]);
  return e;
}
var Oc = Vi("animationend"),
  Ec = Vi("animationiteration"),
  Pc = Vi("animationstart"),
  xc = Vi("transitionend"),
  Lc = new Map(),
  ma =
...
for (var gl = 0; gl < ma.length; gl++) {
  var wl = ma[gl],
    ep = wl.toLowerCase(),
    tp = wl[0].toUpperCase() + wl.slice(1);
  zt(ep, "on" + tp);
}
zt(Oc, "onAnimationEnd");
zt(Ec, "onAnimationIteration");
zt(Pc, "onAnimationStart");
...
var Bn =
  ...
  np = new Set("cancel close invalid load scroll toggle".split(" ").concat(Bn));
function ya(e, t, n) {
  ...
  if (!e[Ir]) {
    (e[Ir] = !0),
      Hs.forEach(function (n) {
        n !== "selectionchange" && (np.has(n) || Sl(n, !1, e), Sl(n, !0, e));
      });
      ...
      e: {
        ...
        if (
          ...
          if (
            ...
            t: {
              for (g = S, f = w, s = 0, d = g; d; d = qt(d)) s++;
              for (d = 0, y = f; y; y = qt(y)) d++;
              for (; 0 < s - d; ) (g = qt(g)), s--;
              for (; 0 < d - s; ) (f = qt(f)), d--;
              for (; s--; ) {
...
var ho = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  op =
    typeof queueMicrotask == "function"
      ...
      : typeof Sa < "u"
      ? function (e) {
          return Sa.resolve(null).then(e).catch(up);
        }
      : ho;
function up(e) {
  setTimeout(function () {
...
function Mc(e, t, n) {
  ...
  if (((t = t.childContextTypes), typeof r.getChildContext != "function"))
    return n;
  r = r.getChildContext();
  for (var i in r) if (!(i in t)) throw Error(O(108, Zd(e) || "Unknown", i));
  return ee({}, n, r);
}
function hi(e) {
  return (
...
function jt() {
  if (!_l && lt !== null) {
    ...
    try {
      ...
      throw (lt !== null && (lt = lt.slice(e + 1)), rc(iu, jt), i);
    } finally {
      (b = t), (_l = !1);
    }
  }
...
function $r(e) {
  ...
  if (
    ...
    if (yo(e)) throw (Dc(), Error(O(418)));
    for (; t; ) jc(e, t), (t = Et(t.nextSibling));
  }
  if ((Ea(e), e.tag === 13)) {
...
var fp = pt.ReactCurrentBatchConfig;
function Fn(e, t, n) {
  if (
...
function Eu(e, t, n, r, i, l) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (qr.current = e === null || e.memoizedState === null ? mp : yp),
    (e = n(r, i)),
    qn)
  ) {
    l = 0;
    do {
      if (((qn = !1), (hr = 0), 25 <= l)) throw Error(O(301));
      (l += 1),
        (ae = oe = null),
        (t.updateQueue = null),
        (qr.current = gp),
...
function Uc(e, t) {
  ...
  if (
    ...
    if (
      ((n.flags |= 2048),
      mr(9, bc.bind(null, n, r, i, t), void 0, null),
      se === null)
    )
      throw Error(O(349));
    Bt & 30 || Vc(n, t, i);
...
function bc(e, t, n, r) {
  (t.value = n), (t.getSnapshot = r), Qc(t) && Zc(e);
}
function Bc(e, t, n) {
  return n(function () {
    Qc(t) && Zc(e);
...
function Gc(e, t, n) {
  return (
    (n = n != null ? n.concat([e]) : null), Qi(4, 4, qc.bind(null, t, e), n)
  );
}
function Lu() {}
function Jc(e, t) {
...
function tf(e, t, n) {
  return Bt & 21
    ? (Ke(n, t) || ((n = oc()), (J.lanes |= n), (Qt |= n), (e.baseState = !0)),
      t)
...
function vp(e, t, n) {
  ...
  if (rf(e)) lf(t, i);
    ...
    (n = $c(e, t, i, r)),
      n !== null && ((i = we()), Ze(n, e, r, i), of(n, t, r));
  }
}
function rf(e) {
  var t = e.alternate;
  ...
  mp = {
    ...
    useImperativeHandle: function (e, t, n) {
      return (
        ...
        Gr(4194308, 4, qc.bind(null, t, e), n)
      );
    },
    ...
    useTransition: function () {
      var e = Ta(!1),
        t = e[0];
      return (e = pp.bind(null, e[1])), (qe().memoizedState = e), [t, e];
    },
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      return (
        ...
        (r.flags |= 2048),
        mr(9, bc.bind(null, r, l, n, t), void 0, null),
        n
      );
    },
    useId: function () {
...
function Ra(e, t, n) {
  ...
  i.has(n) || (i.add(n), (e = Rp.bind(null, e, t, n)), t.then(e, e));
}
function ja(e) {
  do {
    var t;
...
var Sp = pt.ReactCurrentOwner,
  Oe = !1;
function ge(e, t, n, r) {
  t.child = e === null ? Hc(t, null, n, r) : kn(t, e.child, n, r);
}
...
function Ha(e, t, n, r, i) {
  if (e === null) {
    ...
    return typeof l == "function" &&
      ...
      ? ((t.tag = 15), (t.type = l), cf(e, t, l, r, i))
...
function $a(e, t, n, r, i) {
  ...
  if ((vn(t, i), t.stateNode === null))
    Jr(e, t), uf(t, n, r), Co(t, n, r, i), (r = !0);
  else if (e === null) {
    var o = t.stateNode,
      u = t.memoizedProps;
    o.props = u;
...
function _p(e, t, n) {
  ...
  switch ((hu(t), t.tag)) {
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || G.current & 1 ? ue === 0 && (ue = 3) : Du())),
    ...
    case 17:
      return Pe(t.type) && pi(), he(t), null;
    case 19:
      if ((K(G), (l = t.memoizedState), l === null)) return he(t), null;
...
function wf(e) {
  ...
  t !== null && ((e.alternate = null), wf(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Ge], delete t[fr], delete t[vo], delete t[ap], delete t[sp])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
    ...
    case 5:
      ...
      if (r & 4 && ((i = e.stateNode), i != null)) {
        ...
        if (((e.updateQueue = null), a !== null))
          try {
            u === "input" && l.type === "radio" && l.name != null && Vs(i, l),
              eo(u, o);
            var c = eo(u, l);
          ...
          for (M = i; M !== null; )
            (o = M),
              ...
              o.tag === 22 && o.memoizedState !== null
                ...
                ? ((a.return = o), (M = a))
                : Qa(i);
        for (; l !== null; ) (M = l), _f(l), (l = l.sibling);
        (M = i), (Wr = u), (ve = c);
      }
      ba(e);
    } else
...
function xe(e, t) {
  ...
  if (r === 0)
    ...
    if ((n != null && ta(n), t === 1))
      e.tag === 0 ? cp(Za.bind(null, e)) : zc(Za.bind(null, e)),
        op(function () {
          !(V & 6) && jt();
        }),
        (n = null);
...
function Of(e, t) {
  ...
  return xe(e, re()), e.callbackNode === n ? Of.bind(null, e) : null;
}
function jo(e, t) {
  var n = Jn;
  return (
...
function Wt(e, t) {
  ...
  if ((n !== -1 && ((e.timeoutHandle = -1), lp(n)), le !== null))
...
function Mp() {
  for (; le !== null && !n1(); ) xf(le);
}
function xf(e) {
  var t = Nf(e.alternate, e, Te);
...
function Ht(e, t, n) {
  var r = b,
    i = Fe.transition;
  try {
    (Fe.transition = null), (b = 1), zp(e, t, n, r);
  } finally {
    (Fe.transition = i), (b = r);
  }
  return null;
...
Nf = function (e, t, n) {
  ...
  else (Oe = !1), X && t.flags & 1048576 && Rc(t, mi, t.index);
...
Gi.prototype.render = Fu.prototype.render = function (e) {
  var t = this._internalRoot;
  if (t === null) throw Error(O(409));
  qi(e, t, null, null);
};
Gi.prototype.unmount = Fu.prototype.unmount = function () {
...
qs = Ru;
Gs = Zt;
var Up = { usingClientEntryPoint: !1, Events: [kr, rn, bi, Ys, Xs, Ru] },
  Wn = {
  ...
  Vp = {
    ...
    findFiberByHostInstance: Wn.findFiberByHostInstance || Ap,
...
Re.hydrateRoot = function (e, t, n) {
  ...
  if (
    ...
    (t = Rf(t, null, e, 1, n ?? null, i, !1, l, o)),
    (e[ct] = t.current),
    sr(e),
    r)
  )
...
var bp = js.exports,
  qa = bp;
(Ul.createRoot = qa.createRoot), (Ul.hydrateRoot = qa.hydrateRoot);
const Bp = " ./assets/personal-3fb1f909.png",
  Qp = " ./assets/community-fb2bcaab.jpg";
function Zp() {
  return m("div", {
    ...
    children: z("div", {
      ...
      children: [
        ...
        m("div", {
          children: m("img", { className: "communityimage", src: Qp }),
        }),
      ],
    }),
  });
}
const Ga = " ./assets/LUROUND1-6d5fd5b1.png",
    ...
    children: [
      z("div", {
        ...
        children: [
          z("div", {
            ...
            children: [
              z("div", {
                ...
                children: [
                  m("img", { className: "image-luround", src: Ga }),
                  m("a", {
          ...
          m("img", { className: "luround", src: Ga }),
          z("ul", {
            className: "ullist",
            children: [
              m("li", {
...
function es(e) {
  ...
  e = e.replace(c0, "");
  var n = d0.test(e);
  return n || p0.test(e) ? h0(e.slice(2), n ? 2 : 8) : f0.test(e) ? Ja : +e;
}
var E0 = k0,
  Ff = { exports: {} };
/*!
...
var yn = (L.safePreventDefault = function (t) {
  ...
  Uf = (L.getOnDemandLazySlides = function (t) {
    for (var n = [], r = Vf(t), i = bf(t), l = r; l < i; l++)
      t.lazyLoadedList.indexOf(l) < 0 && n.push(l);
    return n;
  });
L.getRequiredLazySlides = function (t) {
  for (var n = [], r = Vf(t), i = bf(t), l = r; l < i; l++) n.push(l);
  return n;
};
var Vf = (L.lazyStartIndex = function (t) {
    return t.currentSlide - M0(t);
  }),
  bf = (L.lazyEndIndex = function (t) {
  ...
  Qf = (L.getSwipeDirection = function (t) {
...
L.initializedState = function (t) {
  ...
  var h = t.lazyLoadedList || [],
    S = Uf(Y(Y({}, t), {}, { currentSlide: p, lazyLoadedList: h }));
  h = h.concat(S);
  var w = {
    slideCount: n,
    slideWidth: u,
...
L.slideHandler = function (t) {
  ...
  if (i) {
    ...
    (x = g),
      ...
      l || (f === s && (g = x), (f = s)),
      a && (w = w.concat(Uf(Y(Y({}, t), {}, { currentSlide: g })))),
      S
        ? ((d = {
            animating: !0,
            currentSlide: x,
            trackStyle: Kf(Y(Y({}, t), {}, { left: f })),
            lazyLoadedList: w,
            targetSlide: k,
          }),
          (y = {
...
L.swipeEnd = function (t, n) {
  ...
  if (l.swipeLength > x) {
    ...
    switch (f) {
      case "left":
      case "up":
        (y = k + rs(n)), (d = v ? ns(n, y) : y), (s.currentDirection = 0);
        break;
      case "right":
      case "down":
        (y = k - rs(n)), (d = v ? ns(n, y) : y), (s.currentDirection = 1);
        break;
      default:
        d = k;
    }
...
var R0 = (L.getNavigableIndexes = function (t) {
  ...
  ns = (L.checkNavigable = function (t, n) {
    var r = R0(t),
      i = 0;
  ...
  Kf = (L.getTrackAnimateCSS = function (t) {
    Uu(t, [
      "left",
      "variableWidth",
      "slideCount",
...
il.Dots = (function (e) {
  ...
  var t = nh(n);
  function n() {
    return G0(this, n), t.apply(this, arguments);
  }
  return (
    J0(n, [
      {
      ...
      },
      {
        ...
        value: function () {
          for (
            ...
            var f = (x + 1) * c - 1,
              s = a ? f : (0, os.clamp)(f, 0, p - 1),
              d = s - (c - 1),
              y = a ? d : (0, os.clamp)(d, 0, p - 1),
              k = (0, Y0.default)({
...
Ln.PrevArrow = (function (e) {
  ...
  var t = ud(n);
  function n() {
    return rd(this, n), t.apply(this, arguments);
  }
  return (
    id(n, [
      {
...
function Sh(e) {
  ...
  if (
    (r.boxSizing === "border-box" &&
      (Math.round(u + l) !== t && (u -= fs(r, "left", "right") + l),
      Math.round(a + o) !== n && (a -= fs(r, "top", "bottom") + o)),
    !kh(e))
  ) {
...
var Eh = (function () {
  ...
  Ph = (function () {
    function e(t, n) {
      var r = Oh(n);
      cd(this, { target: t, contentRect: r });
    }
    return e;
  })(),
  xh = (function () {
  ...
  dd = typeof WeakMap < "u" ? new WeakMap() : new sd(),
  pd = (function () {
    function e(t) {
...
["observe", "unobserve", "disconnect"].forEach(function (e) {
  pd.prototype[e] = function () {
    var t;
    return (t = dd.get(this))[e].apply(t, arguments);
  };
});
var Lh = (function () {
  return typeof Di.ResizeObserver < "u" ? Di.ResizeObserver : pd;
})();
    ...
    Fh(this, n),
      ...
      W(A(i), "adaptHeight", function () {
        if (i.props.adaptiveHeight && i.list) {
          ...
          i.list.style.height = (0, q.getHeight)(o) + "px";
        }
      }),
      W(A(i), "componentDidMount", function () {
        if ((i.props.onInit && i.props.onInit(), i.props.lazyLoad)) {
          var o = (0, q.getOnDemandLazySlides)(I(I({}, i.props), i.state));
          o.length > 0 &&
      ...
      W(A(i), "componentDidUpdate", function (o) {
        if (
          ...
          var u = (0, q.getOnDemandLazySlides)(I(I({}, i.props), i.state));
          u.length > 0 &&
      ...
      W(A(i), "updateState", function (o, u, a) {
        var c = (0, q.initializedState)(o);
        o = I(I(I({}, o), c), {}, { slideIndex: c.currentSlide });
        var v = (0, q.getTrackLeft)(o);
        o = I(I({}, o), {}, { left: v });
        var p = (0, q.getTrackCSS)(o);
        (u ||
          ye.default.Children.count(i.props.children) !==
      ...
      W(A(i), "ssrInit", function () {
        ...
        var x = ye.default.Children.count(i.props.children),
          ...
          s = (0, q.getPreClones)(f) + (0, q.getPostClones)(f) + x,
          d = (100 / i.props.slidesToShow) * s,
          y = 100 / s,
          k = (-y * ((0, q.getPreClones)(f) + i.state.currentSlide) * d) / 100;
      ...
      W(A(i), "progressiveLazyLoad", function () {
        for (
          ...
          a < i.state.slideCount + (0, q.getPostClones)(u);
          a++
        )
      ...
      W(A(i), "keyHandler", function (o) {
        var u = (0, q.keyHandler)(o, i.props.accessibility, i.props.rtl);
      ...
      W(A(i), "swipeStart", function (o) {
        ...
        var u = (0, q.swipeStart)(o, i.props.swipe, i.props.draggable);
        u !== "" && i.setState(u);
      }),
      ...
      W(A(i), "play", function () {
        ...
        else if ((0, q.canGoNext)(I(I({}, i.props), i.state)))
      ...
      W(A(i), "render", function () {
        ...
        (g.clickHandler = i.changeSlide),
          i.props.arrows &&
            ((S = ye.default.createElement(ds.PrevArrow, g)),
            (w = ye.default.createElement(ds.NextArrow, g)));
        var x = null;
